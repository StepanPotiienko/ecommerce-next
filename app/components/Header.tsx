        ...
        <header className='w-screen'>
            <div className='header-container flex flex-row justify-between'>
                <div id='header-menu' className="flex flex-row text-center w-64 h-full">
                    ...
                    <Link href="#"><div className='inline-block header-menu-item w-16 min-h-16 h-full'><ShoppingCart /></div></Link>
                    {!props.isLoggedIn ? < Link href='./login'><div className='inline-block header-menu-item w-16 min-h-16 h-full'><LogIn /></div></Link> : <></>}
                </div>
